 ...
 */
contract DimoCredit is ERC20, FunctionsClient, ConfirmedOwner {
  ...
  constructor(address oracle) ERC20("Dimo Credit", "DC", 18) FunctionsClient(oracle) ConfirmedOwner(msg.sender) {}
